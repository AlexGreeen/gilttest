...
class W_SalesVE implements Parcelable {
    ...
    public W_SalesVE(String name, String sale, String saleKey, String store, String description, String saleUrl, String begins, String ends, String imageUrl, Integer imageWidth, Integer imageHeight) {
        this.name = name;
        this.sale = sale;
